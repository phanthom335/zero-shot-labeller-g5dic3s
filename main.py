    """
    Zero Shot Labeller G5dic3s
    ==========================
    Open-source NLP tool built to rewrite text data with state-of-the-art techniques.
    ...
    APP_NAME    = "Zero Shot Labeller G5dic3s"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source NLP tool built to rewrite text data with state-of-the-art techniques.")
